...
export function Airdrop() {
    ...
    async function sendAirdropToUser() {
        ...
        try {
            const signature = await connection.requestAirdrop(wallet.publicKey, amount * 1000000000);
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-white to-gray-100 px-4">
            <div className="w-full max-w-md bg-white text-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200">
                <h1 className="text-2xl font-bold text-center text-gray-900 mb-6">⚡ Solana Airdrop</h1>
                ...
                {wallet.publicKey && (
                    <p className="text-sm break-words mb-4 text-gray-700">
                        Connected Wallet: <span className="font-medium text-gray-900">{wallet.publicKey.toString()}</span>
                    </p>
                )}
